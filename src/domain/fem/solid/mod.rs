...
use crate::math::{TensorRank1Vec, TensorRank2SparseVec2DSymmetric, TensorRank2SparseVec2D};
...
pub type NodalStiffnessesSolidSymmetric<const D: usize> = TensorRank2SparseVec2DSymmetric<D, 1, 1>;
