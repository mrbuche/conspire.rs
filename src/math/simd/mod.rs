...
pub(crate) fn axpy(target: &mut [Scalar], column: &[Scalar], w: Scalar) {
    #[cfg(feature = "nightly")]
    return portable::axpy(target, column, w);
...
pub(crate) fn rank_one_quad(
    ...
    #[cfg(feature = "nightly")]
    return portable::rank_one_quad(temp_0, temp_1, temp_2, temp_3, column, u);
    #[cfg(not(feature = "nightly"))]
    {
        #[cfg(target_arch = "x86_64")]
        if isa() == Isa::Avx2 {
...
pub(crate) fn rank_two_quad(
    ...
    #[cfg(feature = "nightly")]
    return portable::rank_two_quad(temp_0, temp_1, temp_2, temp_3, column, other, u, w);
    #[cfg(not(feature = "nightly"))]
    {
        #[cfg(target_arch = "x86_64")]
        if isa() == Isa::Avx2 {
            ...
            return unsafe {
                avx::rank_two_quad(temp_0, temp_1, temp_2, temp_3, column, other, u, w)
            };
        }
        column
            .iter()
