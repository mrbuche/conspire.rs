...
impl<Y, Z, U, V> DaeSolverZerothOrderRoot<Y, Z, U, V> for DormandPrince
where
    Y: Tensor,
    Z: Tensor,
    U: TensorVec<Item = Y>,
...
impl<Y, Z, U, V> VariableStepExplicitDaeSolverZerothOrderRoot<Y, Z, U, V> for DormandPrince
where
    Y: Tensor,
    Z: Tensor,
    U: TensorVec<Item = Y>,
...
impl<F, J, Y, Z, U, V> DaeSolverFirstOrderRoot<F, J, Y, Z, U, V> for DormandPrince
where
    Y: Tensor,
    Z: Tensor,
    U: TensorVec<Item = Y>,
