...
pub fn bogacki_shampine<'a>() -> Vec<[&'a str; 2]> {
    vec![[
        ...
        include_str!("ode/explicit/bogacki_shampine/doc.md"),
    ]]
}
...
pub fn dormand_prince<'a>() -> Vec<[&'a str; 2]> {
    vec![[
        ...
        include_str!("ode/explicit/dormand_prince/doc.md"),
    ]]
}
...
pub fn verner_8<'a>() -> Vec<[&'a str; 2]> {
    vec![[
        ...
        include_str!("ode/explicit/verner_8/doc.md"),
    ]]
}
...
pub fn verner_9<'a>() -> Vec<[&'a str; 2]> {
    vec![[
        ...
        include_str!("ode/explicit/verner_9/doc.md"),
    ]]
}
