...
pub type TensorRank1List2D<const D: usize, I, const M: usize, const N: usize> =
    TensorList<TensorRank1List<D, I, M>, N>;

impl<const D: usize, I, const M: usize, const N: usize> From<[[[TensorRank0; D]; M]; N]>
    for TensorRank1List2D<D, I, M, N>
{
