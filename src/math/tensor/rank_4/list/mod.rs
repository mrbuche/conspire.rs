...
pub type TensorRank4List<const D: usize, I, J, K, L, const N: usize> =
    TensorList<TensorRank4<D, I, J, K, L>, N>;

impl<const D: usize, I, J, K, L, const N: usize> From<[[[[[TensorRank0; D]; D]; D]; D]; N]>
    for TensorRank4List<D, I, J, K, L, N>
{
