...
/// Shared by [`super::power`] to build [`TensorRank2::eigen`] on top of the same cubic solve.
pub(super) fn solve_cubic_symmetric(
...
/// Shared by [`super::power`]; see [`solve_cubic_symmetric`].
pub(super) fn find_orthonormal_eigenvectors<I>(
...
/// Shared by [`super::power`]; see [`solve_cubic_symmetric`].
pub(super) fn reconstruct_symmetric<I>(
    eigenvalues: TensorRank0List<3>,
