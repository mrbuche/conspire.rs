...
#[derive(Debug)]
pub struct ThermoelasticThermalConduction<C1, C2, P1, P2>
where
    C1: Constitutive<P1>,
    C2: Constitutive<P2>,
{
...
impl<P, C1, C2, P1, P2> Constitutive<P> for ThermoelasticThermalConduction<C1, C2, P1, P2>
where
    C1: Constitutive<P1>,
    C2: Constitutive<P2>,
    P1: Parameters,
...
// impl<P, C1, C2> Solid<P> for ThermoelasticThermalConduction<C1, C2>
// where
//     C1: Thermoelastic<P>,
...
// impl<P, C1, C2> Thermoelastic<P> for ThermoelasticThermalConduction<C1, C2>
// where
//     C1: Thermoelastic<P>,
//     C2: ThermalConduction<P>,
// {
...
// impl<P, C1, C2> Thermal<P> for ThermoelasticThermalConduction<C1, C2>
// where
//     C1: Constitutive<P>,
//     C2: Constitutive<P>,
// {
...
// impl<P, C1, C2> ThermalConduction<P> for ThermoelasticThermalConduction<C1, C2>
// where
//     C1: Thermoelastic<P>,
//     C2: ThermalConduction<P>,
// {
...
// // impl<P, C1, C2> Multiphysics<P> for ThermoelasticThermalConduction<C1, C2>
// // where
// //     C1: Constitutive<P>,
// //     C2: Constitutive<P>,
// // {
...
// impl<P, C1, C2> SolidThermal<P, C1, C2> for ThermoelasticThermalConduction<C1, C2>
// where
//     C1: Thermoelastic<P>,
//     C2: ThermalConduction<P>,
// {
