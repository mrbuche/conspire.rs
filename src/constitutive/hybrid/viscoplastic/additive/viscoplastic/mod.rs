    ...
    Y2: Tensor,
{
    ...
    fn plastic_evolution(
        ...
        let state_variables_2 =
            &TensorTuple::from((state_variables.0.clone(), state_variables.1.1.clone())); // would be nice to avoid theses clones somehow
        ...
        let mandel_stress_1 = (deformation_gradient_e.transpose()
            ...
            * jacobian;
        let mandel_stress_2 = mandel_stress - &mandel_stress_1; // incorrect, need to pass in Fe (and at that point, maybe pass in cauchy instead of mandel)
        let evolution_1 = self
            .0
            .plastic_evolution(mandel_stress_1, state_variables_1)?;
        let (deformation_gradient_rate, dydt_2) = self
            .1
            .plastic_evolution(mandel_stress_2, state_variables_2)?
            .into();
