...
- The model reduces to the elastic [Saint Venant-Kirchhoff model](super::SaintVenantKirchhoff) when $`m=2`$.
- The model reduces to the [Eulerian Almansi-Hamel model](super::AlmansiHamelEulerian) when $`m=-2`$.
