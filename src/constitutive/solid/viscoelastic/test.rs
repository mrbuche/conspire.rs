macro_rules! cauchy_stress_from_deformation_gradient {
    ($constitutive_model: expr, $deformation_gradient: expr) => {
        $constitutive_model.cauchy_stress($deformation_gradient, &get_deformation_gradient_rate())
    };
}
...
macro_rules! cauchy_stress_from_deformation_gradient_simple {
    ($constitutive_model: expr, $deformation_gradient: expr) => {
        $constitutive_model.cauchy_stress($deformation_gradient, &DeformationGradientRate::zero())
    };
}
...
macro_rules! cauchy_stress_from_deformation_gradient_and_deformation_gradient_rate {
    ($constitutive_model: expr, $deformation_gradient: expr, $deformation_gradient_rate: expr) => {
        $constitutive_model.cauchy_stress($deformation_gradient, $deformation_gradient_rate)
    };
}
...
macro_rules! second_piola_kirchhoff_rate_tangent_stiffness_from_deformation_gradient_and_deformation_gradient_rate {
    ($constitutive_model: expr, $deformation_gradient: expr, $deformation_gradient_rate: expr) => {
        $constitutive_model.second_piola_kirchhoff_rate_tangent_stiffness(
            $deformation_gradient,
            $deformation_gradient_rate,
        )
    };
...
macro_rules! test_solid_viscous_constitutive_model
{
    ($constitutive_model: expr) =>
    {
        use crate::
        {
            math::{ContractAllIndicesWithFirstIndicesOf, assert::assert_eq_from_fd},
            mechanics::test::
            {
...
// {
//     ($constitutive_model: ident, $constitutive_model_parameters: expr, $constitutive_model: expr) =>
//     {
