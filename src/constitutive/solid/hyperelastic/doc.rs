...
pub fn buche_silberstein_network<'a>() -> Vec<[&'a str; 2]> {
    vec![
        [
            "constitutive/solid/hyperelastic/buche_silberstein_network",
            include_str!("buche_silberstein_network/doc.md"),
        ],
        [
            "cauchy_stress",
            include_str!("buche_silberstein_network/cauchy_stress.md"),
        ],
        [
            "cauchy_tangent_stiffness",
            include_str!("buche_silberstein_network/cauchy_tangent_stiffness.md"),
        ],
        ["first_piola_kirchhoff_stress", ""],
        ["first_piola_kirchhoff_tangent_stiffness", ""],
        ["second_piola_kirchhoff_stress", ""],
        ...
        [
            "helmholtz_free_energy_density",
            include_str!("buche_silberstein_network/helmholtz_free_energy_density.md"),
        ],
    ]
}
