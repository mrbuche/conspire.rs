    ...
    match case {
        ...
        7 => {
            ...
            match subconfig {
                ...
                1 => cell.add_triangles_2(&TILING7_2, config, 0, 5),
                2 => cell.add_triangles_2(&TILING7_2, config, 1, 5),
                3 => cell.add_triangles_2(&TILING7_3, config, 0, 9),
                4 => cell.add_triangles_2(&TILING7_2, config, 2, 5),
                5 => cell.add_triangles_2(&TILING7_3, config, 1, 9),
                6 => cell.add_triangles_2(&TILING7_3, config, 2, 9),
                _ => {
        ...
        13 => {
            ...
            match subconfig {
                ...
                1..=6 => cell.add_triangles_2(&TILING13_2, config, subconfig as usize - 1, 6),
                7..=18 => cell.add_triangles_2(&TILING13_3, config, subconfig as usize - 7, 10),
                19..=22 => cell.add_triangles_2(&TILING13_4, config, subconfig as usize - 19, 12),
                23..=26 => {
                    let sub = subconfig as usize - 23;
                    if test_internal(cell, case, config, sub as i32, TEST13.get2(config, 6)) {
                        cell.add_triangles_2(&TILING13_5_1, config, sub, 6)
                    } else {
                        cell.add_triangles_2(&TILING13_5_2, config, sub, 10)
                    }
                }
                27..=38 => cell.add_triangles_2(&TILING13_3_, config, subconfig as usize - 27, 10),
                39..=44 => cell.add_triangles_2(&TILING13_2_, config, subconfig as usize - 39, 6),
